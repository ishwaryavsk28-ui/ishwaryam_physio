  ...
  return (
    <section id="about" className="pt-20 md:pt-24 pb-20 md:pb-32 bg-white relative overflow-hidden">
      <div className="container-custom">
        <div className="grid lg:grid-cols-12 gap-y-12 lg:gap-x-24 items-start">
          
          {/* 1. SECTION HEADING (PRIORITY ON MOBILE) */}
          <div className="lg:col-start-6 lg:col-span-7 order-1">
            <motion.div
            ...
            >
              ...
              <h2 className="text-4xl md:text-8xl font-display font-bold text-text-primary leading-[1] tracking-tighter mb-4 md:mb-12">
          ...
          {/* 2. VISUAL IDENTITY (AFTER HEADING ON MOBILE) */}
          ...
          {/* 3. NARRATIVE SIDE (AFTER PORTRAIT ON MOBILE) */}
