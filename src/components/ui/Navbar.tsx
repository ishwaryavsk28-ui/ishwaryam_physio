    ...
    >
      <div className="container-custom flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-4 group">
          <div className="relative w-12 h-12 md:w-14 md:h-14 rounded-full overflow-hidden border-2 border-accent/20 bg-white shadow-sm flex-shrink-0 flex items-center justify-center p-1">
            <img 
              src="/logo.png" 
